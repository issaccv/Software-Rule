...
## 1 资源接收规则
### 1.1制作组接收规则
软件类资源对制作组并无特殊要求，无论官方版本或个人打包、优化、破解、绿化版本的软件皆在接收范围之内。
...
软件类资源不接收体积小于50MB等无分流和共享服务意义的软件资源，包括但不限于由官方站点提供http或ftp下载且文件小于50M的开源、免费、共享软件，以及可以在华军、霏凡、天空、迅雷狗狗搜索等其他软件站下载的小于50M的软件。比如：不接受人人，优酷，爱奇艺，QQ，各种安全卫士，各种浏览器，各种网盘、云盘等客户端。
...
(8)其他信息（选填）
 该软件版本更新内容，更新时间，自己的使用感受，软件MD5校验截图等。
...
### 4.5 合集的软件。
   例如“装机软件大全”、“常用软件汇总”，不利于检索和保种的资源。
   同一版本软件32位和64位的可以一起发布也可以分别发布。
